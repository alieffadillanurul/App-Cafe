...
public class Makanan extends AppCompatActivity {
    ...
    String nama_makanan, size_snack, harga_makanan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                size_snack = editTextSize.getText().toString();
                harga_makanan = editTextHarga.getText().toString();

                makanan(nama_makanan, size_snack, harga_makanan);
            }
        });
        ...
        buttonView.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                startActivity(new Intent(Makanan.this, DataSnack.class));
            }
        });

    }
    private void makanan(String nama_makanan, String size_snack, String harga_makanan) {
        class AddMakanan extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String s) {
                ...
                if (editTextName.getText().toString().trim().length() == 0
                        || editTextSize.getText().toString().trim().length() == 0
                        || editTextHarga.getText().toString().trim().length() == 0) {
                    Toast.makeText(getApplicationContext(), s, Toast.LENGTH_LONG).show();
                } else {
                    Intent i = new Intent(Makanan.this, DataSnack.class);
                    finish();
                    startActivity(i);
                    Toast.makeText(getApplicationContext(), s, Toast.LENGTH_LONG).show();
                }
        ...
        ru.execute(nama_makanan, size_snack, harga_makanan);
    }
}
