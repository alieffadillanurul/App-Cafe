...
public class UpdateMinuman extends AppCompatActivity {
    ...
    private EditText editTextNo, editTextName, editTextTeksture, editTextPesan;
        ...
        buttonUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (editTextName.getText().toString().trim().length() == 0
                    ...
                    updateMinuman();
                    startActivity(new Intent(UpdateMinuman.this, DataDrink.class));
                    finish();
                }
            }
        });
    ...
    private void updateMinuman(){
        ...
        final String tekstur = editTextTeksture.getText().toString();
