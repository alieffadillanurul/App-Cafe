...
public class MainActivity extends AppCompatActivity {
    ...
    String fullname, gender, address, testimonial;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        simpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                testimonial = editTextKesan.getText().toString();

                pesan(fullname, gender, address, testimonial);
            }
        });
    ...
    private void pesan(String fullname, String gender, String address, String kesan) {
        ...
        ru.execute(fullname, gender, address, testimonial);
    }
}