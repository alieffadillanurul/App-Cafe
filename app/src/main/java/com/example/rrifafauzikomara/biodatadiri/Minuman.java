...
public class Minuman extends AppCompatActivity {
    ...
    private EditText editTextName, editTextTeksture,  editTextPesan;
    ...
    String nama_drink, tekstur, sedotan, tempat, nama_pemesan;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextTeksture = (EditText) findViewById(R.id.editTextTeksture);
        ...
        buttonAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                nama_drink = editTextName.getText().toString();
                tekstur = editTextTeksture.getText().toString();
                sedotan = sd;
                tempat = tp;
                nama_pemesan = editTextPesan.getText().toString();

                minuman(nama_drink, tekstur, sedotan, tempat, nama_pemesan);
            }
        });
        ...
        buttonView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Minuman.this, DataDrink.class));
                finish();
            }
        });

    }
    private void minuman(String nama_minuman, String teksur, String sedotan, String tempat, String nama_pemesan) {
        class AddMinuman extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String s) {
                ...
                if (editTextName.getText().toString().trim().length() == 0
                        || editTextTeksture.getText().toString().trim().length() == 0
                        || editTextPesan.getText().toString().trim().length() == 0) {
                    Toast.makeText(getApplicationContext(), s, Toast.LENGTH_LONG).show();
                } else {
                    Intent i = new Intent(Minuman.this, DataDrink.class);
                    finish();
                    startActivity(i);
                    Toast.makeText(getApplicationContext(), s, Toast.LENGTH_LONG).show();
                }
        ...
        am.execute(nama_minuman, tekstur, sedotan, tempat, nama_pemesan);
    }
    }