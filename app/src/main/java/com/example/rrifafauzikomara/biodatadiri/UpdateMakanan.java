...
public class UpdateMakanan extends AppCompatActivity {
    ...
    private EditText editTextNama, editTextSize, editTextHarga, editTextNo;
        ...
        buttonUpdate.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                if (editTextNama.getText().toString().trim().length() == 0
                    ...
                    updateMakanan();
                    startActivity(new Intent(UpdateMakanan.this, DataSnack.class));
                    finish();
                }
            }
        });
    ...
    private void updateMakanan(){
        ...
        final String size_snack = editTextSize.getText().toString();
        ...
        class UpdateMakanan1 extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                ...
                hashMap.put("size_snack",size_snack);
